...
public class DealWithMenuJson {
	...
	public void test() {
		...
		String activityMenu = "{\"type\":\"view\",\"name\":\"今日派赠\",\"url\":\"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxa1c8a107ae33becc&redirect_uri=http%3A%2F%2Fvps1.taoware.com%2Ftest%2F&response_type=code&scope=snsapi_userinfo#wechat_redirect\"},";
		System.out.println(activityMenu);
		String pushMenu = "{\"type\":\"click\",\"name\":\"志愿者\",\"key\":\"1\"},";
		System.out.println(pushMenu);
	}
}
